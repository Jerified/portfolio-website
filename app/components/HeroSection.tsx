    ...
    <section className='px-6 py-8 max-w-6xl  mx-auto'>
        <div className="md:flex justify-between gap-12 items-center text-white">
            <div className="">
                ...
                <AnimatedText text='Crafting meaningful and impartful design' className='font-medium text-[2.4rem] sm:text-[2.8rem] md:text-[3rem] lg:text-[3.75rem] tracking-wie lg:leading-[4rem] leading-[2.5rem] md:leading-[3rem] pt-3'repeatDelay={10000} />
                {/* <p className="font-medium text-[2.4rem] sm:text-[2.8rem] md:text-[3rem] lg:text-[3.75rem] tracking-wie lg:leading-[4rem] leading-[2.5rem] md:leading-[3rem] pt-3"><span className="text-orange-500 pr-3">Crafting</span>meaningful <br/> And impartful <br /> designs. </p> */}
